...
public class TipoPixController : BaseController
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(GetTipoPixResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ResultadoErro), StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<List<GetTipoPixResponse>>> GetTipoPixAsync()
    {
        var request = new GetTipoPixRequest();
